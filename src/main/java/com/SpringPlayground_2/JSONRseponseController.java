...
//        public String objectParams(@Reque ){
//           String returnedString = "Search: ";
//
//           return  returnedString;
//

    @PostMapping("/testing")
    public String getJson (@RequestBody Map<String, String> jsonBody){
        String returnedString = String.format("Search: q=something from =%s",jsonBody.get("from"));
    ...
    @PostMapping("/test2")
    public Map<String, String> getObjectMapper(@RequestBody Map<String, String> jsonBody){
           return jsonBody;
    }
